...
#     from app.modules.whatsapp.model import Whatsapp
...
#     from app.modules.scheduled_post.model import ScheduledPost
...
class Organisation(Base):
    ...
    tone: Mapped[ToneEnum] = mapped_column(nullable=False)
    sector: Mapped[SectorEnum] = mapped_column(nullable=False)
