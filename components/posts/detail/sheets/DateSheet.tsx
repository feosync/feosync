  ...
  const preview = newDate
    ? (() => {
        try {
          ...
          return format(utc, "EEEE d MMMM yyyy 'à' HH:mm 'UTC'", {
            locale: fr,
          });
        } catch {
          return "";
        ...
        <div className="flex-1 px-6 py-6 space-y-5">
          ...
          <div className="space-y-1.5">
            ...
            <input
              ...
              className="w-full border border-border rounded-lg px-3 py-2.5 text-sm bg-input text-foreground focus:outline-none focus:ring-2 focus:ring-ring transition-shadow [color-scheme:light] dark:[color-scheme:dark]"
            />
          ...
          {isScheduled && (
            <p className="text-xs text-muted-foreground bg-muted rounded-lg px-3 py-2.5 border border-border">
              ⚠️ La modification replanifiera automatiquement la tâche Celery
              associée.
            </p>
          )}
        </div>
