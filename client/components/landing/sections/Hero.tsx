      ...
      <div className="flex items-start gap-2 px-3 py-2.5 rounded-2xl bg-card border border-border shadow-lg">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center justify-between mb-0.5">
            <span className="text-[10px] font-bold uppercase tracking-wider" style={{ color: "#1877F2" }}>
              Facebook
            </span>
            <span className="text-[9px] text-muted-foreground ml-1">maintenant</span>
          </div>
      ...
      <div className="flex items-start gap-2 px-3 py-2.5 rounded-2xl bg-card border border-border shadow-lg">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-1.5 mt-1">
            ...
            <span className="text-[9px] text-muted-foreground ml-0.5">47 réactions</span>
          </div>
        </div>
      </div>
    </motion.div>
        ...
        >
          ...
          <Card className="relative z-10 w-full shadow-xl border-border h-max">
            ...
            <div className="grid grid-cols-3 gap-1.5 sm:gap-2 px-4 sm:px-6 mb-2">
              {[
                { label: "Portée totale",  value: `${(totalReach / 1000).toFixed(0)}k`, color: "text-primary"   },
                { label: "Meilleur jour",  value: bestDay.day,                           color: "text-chart-1"   },
                ...
                <div key={label} className="bg-muted/50 rounded-xl px-2 sm:px-3 py-2 sm:py-2.5 text-center">
                  ...
                  <p className={`text-[15px] sm:text-[18px] font-bold leading-none ${color}`}>
                    {value}
                  </p>
                </div>
              ))}
