...
const FacebookBubble = () => (
  ...
  >
    ...
    >
      <div
        className="flex items-start gap-2 px-3 py-2.5 rounded-2xl"
        style={{
          background: "white",
          border: "1px solid rgba(24,119,242,0.15)",
          boxShadow:
            "0 12px 32px rgba(24,119,242,0.15), 0 2px 8px rgba(0,0,0,0.08)",
        }}
      >
        <div
      ...
      <div
        ...
        style={{
          background: "white",
          borderRight: "1px solid rgba(24,119,242,0.15)",
...
const WhatsAppBubble = () => (
  <motion.span
    ...
    style={{ willChange: "transform" }}
  >
    {/* Float animation fusionné — un seul layer GPU */}
    <motion.div
      animate={{ y: [0, -6, 0] }}
      transition={{
        duration: 4,
    ...
    >
      ...
      <div
        ...
        style={{
          background: "white",
          borderLeft: "1px solid rgba(37,211,102,0.18)",
          borderTop: "1px solid rgba(37,211,102,0.18)",
        }}
      />
      ...
      <div
        ...
        style={{
          ...
          boxShadow:
            "0 12px 32px rgba(37,211,102,0.15), 0 2px 8px rgba(0,0,0,0.08)",
        }}
      >
        {/* Icon */}
        <div
                ...
                <Card className="relative z-10 w-full shadow-hero-card border-google-border">
                  <CardHeader className="pb-3">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        <div className="w-6 h-6 bg-google-blue rounded-sm flex items-center justify-center text-[10px] text-primary-foreground font-bold">
                          A
                        </div>
                  ...
                  <div className="grid grid-cols-3 gap-1.5 sm:gap-2 px-4 sm:px-6 mb-2">
                    {[
                      ...
                      >
                        <p className="text-[9px] sm:text-[10px] text-muted-foreground font-ui mb-0.5 sm:mb-1 leading-tight">
                          {label}
                        </p>
                        <p
                          className={`text-[15px] sm:text-[18px] font-display font-bold leading-none ${color}`}
                        >
                          {value}
                        </p>
                      </div>
                  ...
                  <CardFooter className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 pt-0 border-t border-border px-4 sm:px-6 pb-4">
                    <div className="flex items-center gap-1.5 text-[11px] sm:text-[12px] text-muted-foreground">
                      <TrendingUp
                        size={13}
                        className="text-google-teal flex-shrink-0"
                      />
                      <span>
                        Portée en hausse de{" "}
                        <strong className="text-foreground">+18%</strong> cette
                        semaine
                      </span>
                    </div>
