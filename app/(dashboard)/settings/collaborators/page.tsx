...
import { Users, UserPlus, X, Building2 } from "lucide-react"
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      ...
                      <span className="text-xs text-muted-foreground">
                        {collab.assigned_organizations.length} organisation(s)
                      </span>
                    </div>
                  </div>
      ...
      >
        ...
        <div className="relative bg-card border border-border rounded-2xl shadow-2xl max-w-sm w-[calc(100%-2rem)] p-6 space-y-4">
          ...
          <p className="text-sm text-muted-foreground">
            Ce collaborateur perdra l&apos;accès à toutes les organisations assignées.
          </p>
